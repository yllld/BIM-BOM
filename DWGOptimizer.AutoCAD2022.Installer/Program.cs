    ...
    internal static class Program
    {
        ...
        private static int Main(string[] args)
        {
            ...
            try
            {
                ...
                string contents = Path.Combine(bundle, "Contents", "2022");
...
<ApplicationPackage SchemaVersion=""1.0"" AutodeskProduct=""AutoCAD"" ProductType=""Application"" Name=""DWG Revit Optimizer"" AppVersion=""0.1.0"" ProductCode=""{C3C92975-0DC1-4FA7-9F45-129FD9F3AD7B}"" UpgradeCode=""{81B7BC31-C0B4-4F62-BE7B-E3D35C86E521}"" Author=""BIM BOM"">
  <CompanyDetails Name=""BIM BOM"" />
  <RuntimeRequirements OS=""Win64"" Platform=""AutoCAD*"" SeriesMin=""R24.1"" SeriesMax=""R24.1"" />
  <Components>
    <RuntimeRequirements OS=""Win64"" Platform=""AutoCAD*"" SeriesMin=""R24.1"" SeriesMax=""R24.1"" />
    <ComponentEntry AppName=""DWG Revit Optimizer"" ModuleName=""./Contents/2022/DWGOptimizer.AutoCAD2022.dll"" AppDescription=""Подготовка 3D DWG для Revit"" LoadOnAutoCADStartup=""True"">
      <Commands GroupName=""DWGREVITOPTIMIZER"">
        ...
        <Command Global=""DWGREVITREADYWORKER"" Local=""DWGREVITREADYWORKER"" />
      </Commands>
    </ComponentEntry>
  </Components>
</ApplicationPackage>";
